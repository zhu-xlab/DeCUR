...
#SBATCH --output=srun_outputs/B2B13_train_rn50_rda_decur_%j.out
#SBATCH --error=srun_outputs/B2B13_train_rn50_rda_decur_%j.err
...
--print-freq 100 \
--checkpoint-dir /p/project1/hai_ssl4eo/wang_yi/decur/DeCUR/src/pretrain/checkpoints/B2B13_ssl4eo_decur_rn50_rda \
--backbone resnet50 \
--dist_url $dist_url \
--cos \
--dim_common 7168 \
